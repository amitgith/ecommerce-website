    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-blue-500 to-cyan-400 px-4">
      <div className="w-full max-w-md rounded-3xl border border-white/20 bg-white/10 backdrop-blur-xl shadow-2xl p-8">
        ...
        <div className="flex justify-center">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white/20 border border-white/30">
        ...
        <form className="mt-8 space-y-5">
          ...
          {/* Button */}
          <button
            className="w-full cursor-pointer rounded-xl bg-white py-3 font-semibold text-indigo-600 transition hover:scale-[1.02] hover:bg-gray-100 active:scale-95"
          >
            Sign in
          </button>
